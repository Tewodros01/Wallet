...
export default function AdminWithdrawals() {
  ...
  const pending = withdrawals.filter((w: any) => w.status === "PENDING" || w.status === "PROCESSING");
        ...
        left={
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-gray-500">{withdrawals.length} total · {pending.length} pending</p>
            </div>
          </div>
        }
      />
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  {item.accountNumber && (
                    <div className="bg-white/[0.04] rounded-xl px-3 py-2 col-span-2">
                      <p className="text-[9px] text-gray-500 uppercase tracking-wide">Account</p>
                ...
                {isPending && (
                  <div className="flex gap-2">
                    <button
                      ...
                      onClick={() => handleAction((id, o) => rejectWithdrawal(id, o), item.id)}
                    ...
                    <button
                      type="button"
                      disabled={actionLoading === item.id}
                      onClick={() => handleAction((id, o) => approveWithdrawal(id, o), item.id)}
