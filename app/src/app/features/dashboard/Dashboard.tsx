...
import { useLeaderboard, useMe, useMyStats, useRooms, useUnreadCount } from "./hooks";
...
import LiveRoomCard from "../bingo/components/LiveRoomCard";
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            {meLoading ? (
              ...
              <div className="w-11 h-11 rounded-full bg-white/8 ring-2 ring-emerald-400 flex items-center justify-center text-white text-sm font-black">
      ...
      >
        ...
        <motion.div variants={fadeUp} className="flex flex-col gap-3">
          <div className="flex items-center justify-between">
            ...
            <button
              type="button"
              onClick={() => nav(APP_ROUTES.leaderboard)}
