...
import { LETTER_TEXT } from "./bingoData";
            ...
            {chatMsgs.length === 0 ? (
              ...
              chatMsgs.map((message) => {
                ...
                return (
                  ...
                  >
                    {getPublicAssetUrl(message.avatar) ? (
                      <img
                        src={getPublicAssetUrl(message.avatar) ?? undefined}
                        alt=""
                        className="w-7 h-7 rounded-full object-cover shrink-0"
                      />
                    ) : (
                      <div className="w-7 h-7 rounded-full bg-white/8 shrink-0 flex items-center justify-center text-white text-[10px] font-black">
