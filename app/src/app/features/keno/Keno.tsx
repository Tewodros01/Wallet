...
import KenoBetSelector from "./components/KenoBetSelector";
import KenoNumberGrid from "./components/KenoNumberGrid";
import KenoPayoutTable from "./components/KenoPayoutTable";
import KenoPickSummary from "./components/KenoPickSummary";
import KenoResultBanner from "./components/KenoResultBanner";
import {
  DEFAULT_KENO_STYLE,
  KENO_BETS,
  KENO_DRAW_SIZE,
        ...
        <div className="rounded-3xl border border-white/6 bg-white/3 p-4 flex items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-[11px] text-gray-500">
              {activeStyle.sub} Starts with {activeStyle.picks} picks and a{" "}
              {activeStyle.bet}-coin bet.
            </p>
          </div>
          <button
            type="button"
