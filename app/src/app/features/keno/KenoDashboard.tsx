...
import { useMe, useMyStats, useUnreadCount } from "./hooks";
...
const KENO_TABLES = [
  {
    ...
    badge: "Main",
    path: `${APP_ROUTES.kenoPlay}/classic`,
  },
  {
    key: "quick",
    label: "Quick Draw",
    ...
    badge: "Fast",
    path: `${APP_ROUTES.kenoPlay}/quick`,
  },
  {
    key: "highRoller",
    label: "High Stakes",
    ...
    badge: "Pro",
    path: `${APP_ROUTES.kenoPlay}/highRoller`,
  },
] as const;
      ...
      >
        ...
        >
          ...
          <div className="relative z-10 flex items-center gap-2 mt-3">
            <button
              type="button"
              onClick={() => nav(`${APP_ROUTES.kenoPlay}/classic`)}
            ...
            <button
              type="button"
              onClick={() => nav(APP_ROUTES.kenoHistory)}
