...
const META: Record<ToastType, { icon: React.ReactNode; bar: string; bg: string; text: string }> = {
  success: { icon: <FiCheckCircle />,   bar: "bg-emerald-500", bg: "bg-gray-900 border-emerald-500/30", text: "text-emerald-400" },
  error:   { icon: <FiAlertCircle />,   bar: "bg-rose-500",    bg: "bg-gray-900 border-rose-500/30",    text: "text-rose-400"    },
  warning: { icon: <FiAlertTriangle />, bar: "bg-yellow-500",  bg: "bg-gray-900 border-yellow-500/30",  text: "text-yellow-400"  },
  info:    { icon: <FiInfo />,          bar: "bg-blue-500",    bg: "bg-gray-900 border-blue-500/30",    text: "text-blue-400"    },
};
